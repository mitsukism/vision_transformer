...
parser.add_argument('--checkpoint', default='/content/drive/MyDrive/ch3/hymenoptera/trasfer_weight.pth', type=str, help='checkpoint')
...
image = Image.open('/content/hymenoptera_data/val/ants/1119630822_cd325ea21a.jpg')
